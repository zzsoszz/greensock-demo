(function($){
		...
		var plugname="qmultiselectboxwithinput";
		...
		function PluginObject(target)
		{
				...
				self.init=function(initoptions)
				{
					...
					self.qcomfirm.on("click",function()
						{
                            ...
                            var includeEmpty;
							self.qmultiselectbox.find(".qaddtionitem").find(".qinputvalue").each(function(){
									if($(this).val().trim()=="")
									{
										includeEmpty=true;
										/*$(this).focus();*/
									...
									{
										valuesArray.push($(this).val().trim());
									}
								}
							);
							if(includeEmpty)
							...
							/*
							var valuesArray= self.qmultiselectbox.find(".qaddtionitem.qinputvalue").map(function(){
								return $(this).data("qvalue");
							}).get();
							*/
					...
					self.qadd.on("click",function(){
						var inputitem=self.qinputpaneltemplate.clone().addClass("qaddtionitem").insertAfter(self.qlistgroup).removeClass("qinputpaneltemplate hidden");
