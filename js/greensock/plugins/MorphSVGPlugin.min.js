...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    var e = Math.PI / 180,
        ...
        A = function (e) {
            for (var t, r, n, o, i, a = e.length, s = e[0][0], h = s, l = e[0][1], f = l; --a > -1;) for (i = e[a], t = i.length, o = 6; t > o; o += 6) r = i[o],
            n = i[o + 1],
            r > s ? s = r : h > r && (h = r),
            n > l ? l = n : f > n && (f = n);
        ...
        _ = function (e, t, r) {
            for (var n, o, i, a, s, h, l = e.length, f = 99999999999, g = 0, u = 0; --l > -1;) for (n = e[l], h = n.length, s = 0; h > s; s += 6) o = n[s] - t,
            i = n[s + 1] - r,
            a = Math.sqrt(o * o + i * i),
        ...
        F = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, r, n) {
                ...
                function (e) {
                    e[0] = t.precompile[0],
                    e[1] = t.precompile[1]
                } : "d" === a ? G(t.shapeIndex, t.map || F.defaultMap, t.precompile) : B(t.shapeIndex)), s && (this._overwriteProps.push("morphSVG"), s.end = p, s.endProp = a)), u)) : (c("WARNING: cannot morph a <" + o + "> SVG element. " + O), !1)) : (true == true, !1)
            },
            set: function (e) {
                var t;
