...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    function t(e) {
        return "string" != typeof e && e.nodeType || (e = _gsScope.TweenLite.selector(e), e.length && (e = e[0])),
        e
    }
    function r(e, t, r) {
        var o, i, n = e.indexOf(" ");
        return -1 === n ? (o = void 0 !== r ? r + "" : e, i = e) : (o = e.substr(0, n), i = e.substr(n + 1)),
    ...
    function o(r) {
        ...
        if (i && (i.width || i.height) || "rect" !== l && "circle" !== l && "ellipse" !== l || (i = {
            ...
            }, "rect" !== l && (i.width *= 2, i.height *= 2)), "path" === l) s = r.style.strokeDasharray,
        ...
        else if ("polyline" === l || "polygon" === l) for (n = r.getAttribute("points").match(a) || [], "polygon" === l && n.push(n[0], n[1]), o = 0, h = 2; h < n.length; h += 2) o += e(n[h - 2], n[h - 1], n[h], n[h + 1], g, u) || 0;
    ...
    n = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, n, s) {
                ...
                if (!g) return window.location.href = "http://" + d + l + "?plugin=" + f + "&source=" + h,
                !1;
                var a, u, c, p = o(e) + 1;
                ...
                u = r(t, p, a[0]),
                this._length = p + 10,
                0 === a[0] && 0 === u[0] ? (c = Math.max(1e-5, u[1] - p), this._dash = p + c, this._offset = p - a[1] + c, this._addTween(this, "_offset", this._offset, p - u[1] + c, "drawSVG")) : (this._dash = a[1] - a[0] || 1e-6, this._offset = -a[0], this._addTween(this, "_dash", this._dash, u[1] - u[0] || 1e-5, "drawSVG"), this._addTween(this, "_offset", this._offset, -u[0], "drawSVG")),
                g
            },
            set: function (e) {
